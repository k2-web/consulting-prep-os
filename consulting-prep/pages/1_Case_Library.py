...
with st.sidebar:
    ...
    st.text_input("Search by keyword...", placeholder="Search...")
    
    st.markdown("#### Difficulty")
    st.radio("Difficulty", ["Beginner", "Intermediate", "Advanced"], label_visibility="collapsed")
    
    st.markdown("#### Industry")
    st.selectbox("Industry", ["Technology", "Healthcare", "Consumer Goods", "Finance", "Energy"], label_visibility="collapsed")
    
    st.markdown("#### Case Type")
    st.selectbox("Case Type", ["Profitability", "Market Entry", "M&A", "Growth Strategy"], label_visibility="collapsed")
...
with col2:
    st.selectbox("Sort by", ["Most Popular", "Newest", "Hardest"], label_visibility="collapsed")
